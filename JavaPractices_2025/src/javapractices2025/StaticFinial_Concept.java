...
public class StaticFinial_Concept {
	
	String name;
	int price;
	String model;
	static  int wheels = 4;
	//If value should not be changed in future then we should use final keyword 
	static final int keys=2; // static and final(constant)class variable 
	...
	public static void main(String[] args) {
		...
		//Before i was able to change the keys number but after making final it cnt be changed 
		//Its Constant now 
		
		//System.out.println(StaticConcept_Car.keys=6;);
